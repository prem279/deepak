...
public class ApplicationSearchApplicantResource extends ResourceSupport {
	...
	@Valid
	private List<ApplicationSearchApplicantConditionResource> conditions = new ArrayList<ApplicationSearchApplicantConditionResource>();

	@JsonManagedReference
	@Valid
	private List<ApplicationSearchApplicantProductResource> applicantProducts = new ArrayList<ApplicationSearchApplicantProductResource>();
