...
public class PhoneNumberResource implements Serializable {
	...
	public boolean isNull() {
		return (
			(null == partyPhoneNumberId) &&
			(null == countryCode || countryCode.equals("")) &&
			(null == phoneNumber || phoneNumber.equals("")) &&
			(null == extension || extension.equals("")) &&
