...
public class PhysicalAddressResource extends ResourceSupport implements Serializable {
	...
	public boolean isNull() {
		return (addressId == null && addressReasCode == null && addressLine1Text == null && addressLine2Text == null
				&& cityName == null && stateProvinceCode == null && postalCode == null && countryCode == null);
	}
}
